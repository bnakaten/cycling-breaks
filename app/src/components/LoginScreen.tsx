    ...
    <div className="min-h-screen bg-[#F9FAFB] flex items-center justify-center px-4">
      <div className="max-w-sm w-full space-y-8">
        <div className="text-center space-y-4">
          <div className="w-16 h-16 rounded-xl bg-[#2563EB] flex items-center justify-center text-white mx-auto">
            <Compass size={28} />
          </div>
          <div>
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-lg p-6 space-y-4">
          <p className="text-xs text-[#6B7280] text-center leading-relaxed">
            Verbinde dein Strava-Konto, um GPX-Dateien hochzuladen und
            deine Standzeiten zu analysieren.
          </p>

          {loginError && (
            <div className="bg-red-50 border border-red-200 rounded p-3 text-xs text-red-700 break-all">
              Login fehlgeschlagen: {loginError}
            </div>
          )}
